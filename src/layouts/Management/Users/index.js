        ...
        {selected === "Users" && (
          <View style={styles.container}>
            <ScrollView style={{ flex: 1 }}>
              <View style={styles.titleBackLine}>
                <Text style={styles.titlecenter}>Pending</Text>
              </View>
              <View style={styles.listingspacing}>
                <View style={styles.adminborder}>
                  <View style={styles.adminlisting}>
                    <View style={styles.imgviewwidth}>
                      <Image
                        source={require("./../../../assets/Images/userprofile.png")}
                        style={styles.userprofile}
                      />
                    </View>
                    <View style={styles.adminemail}>
                      <Text style={styles.adminnametxt}>William Weiser</Text>
                      <Text style={styles.admintxtemail}>
                        WilliamKWeiser@jourrapide.com
                      </Text>
                    </View>
                    <View style={styles.toggleswitch}>
                      <TouchableOpacity onPress={() => this.ToggleFunction()}>
                        <View>
                          {this.state.toggle ? (
                            <View>
                              <View style={styles.toggleback}>
                                <View style={styles.toggleround}></View>
                              </View>
                              <Text style={styles.stdnttxt}>Student</Text>
                            </View>
                          ) : (
                            <View>
                              <View style={styles.togglebackstaff}>
                                <View style={styles.toggleroundstaff}></View>
                              </View>
                              <Text style={styles.stafftxt}>Staff</Text>
                            </View>
                          )}
                        </View>
                      </TouchableOpacity>
              ...
              <View style={styles.titleBackLine}>
                <Text style={styles.titlecenter}>Assigned</Text>
              </View>
              <View style={styles.listingspacing}>
                <View style={styles.adminborder}>
                  <View style={styles.adminlisting}>
